...
const slug = "sistemas-a-medida";
const title = "Sistemas a Medida — Tu Propio Software en vez de Excel | B3TA Guatemala";
const description = "Desarrollo de sistemas web a medida en Guatemala. Cotizadores, portales de clientes, dashboards. Deja de usar Excel y ten tu propio software.";
const url = `https://b3ta.us/servicios/${slug}`;
const h1 = "Sistemas a Medida para tu Negocio";
...
const features = ["Sistema web a medida", "Acceso desde celular y PC", "Login con usuarios y roles", "Cotizador con PDF automatico", "Portal de clientes", "Dashboard de ventas", "Base de datos en la nube", "Notificaciones automaticas", "Soporte y mantenimiento"];
