...
export function PublicReportClient({ report, media }: PublicReportClientProps) {
  const router = useRouter();

  if (!report) {
    return (
      <div className="dark text-foreground min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/5 via-background to-accent/5 p-4">
        <Card className="max-w-md w-full">
          <CardContent className="py-12 text-center">
            <FileText className="h-16 w-16 mx-auto mb-4 text-muted-foreground" />
            <h2 className="text-2xl font-bold mb-2">Informe no disponible</h2>
            <p className="text-muted-foreground mb-6">
              Este informe no existe, ha sido eliminado, o aún no ha sido
              publicado. Si recientemente recibiste este enlace, por favor
              contacta con tu consultor de B3TA.
            </p>
              ...
              <Button
                ...
                onClick={() =>
                  (window.location.href =
                    "mailto:hi@b3ta.us?subject=Problema con enlace de informe")
                }
                className="w-full"
              >
  ...
  return (
    <div className="dark text-foreground min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      {/* Header */}
      ...
      <main className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        {/* Report Sections */}
        {report.sections_config.current_situation &&
        ...
        {report.sections_config.recommendations &&
        ...
        <div className="mt-12 pt-8 border-t border-border text-center">
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <span className="font-bold font-sans tracking-normal text-lg">
              B3TA
            </span>
          </div>
          ...
          <p className="text-sm text-muted-foreground">
            www.b3ta.com | info@b3ta.com
          </p>
          <Separator className="my-4" />
          <p className="text-xs text-muted-foreground">
            Este es un documento oficial de B3TA. Confidencial y de uso
            exclusivo para {report.customers.name}.
          </p>
        </div>
      </main>
    </div>
