    ...
    return (
      <div className="dark min-h-screen flex items-center justify-center bg-background text-foreground">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Cargando pagina...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="dark min-h-screen flex items-center justify-center bg-background text-foreground p-4">
        <Card className="max-w-sm w-full">
          <CardContent className="py-8 text-center">
            ...
            <h2 className="text-xl font-bold mb-2">Pagina protegida</h2>
            <p className="text-muted-foreground mb-6 text-sm">
              Ingresa la contrasena para acceder a este contenido.
            </p>
      ...
      <div className="dark min-h-screen flex items-center justify-center bg-background text-foreground p-4">
        <Card className="max-w-md w-full">
          <CardContent className="py-12 text-center">
            ...
            <h2 className="text-2xl font-bold mb-2">Pagina no disponible</h2>
            <p className="text-muted-foreground mb-6">
              Esta pagina no existe o ha sido desactivada.
            </p>
            <div className="space-y-3">
              <Button onClick={() => router.push('/')} className="w-full">Ir al inicio</Button>
