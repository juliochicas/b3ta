...
import { Edit, Trash2, DollarSign, Package, ChevronLeft, ChevronRight } from "lucide-react";
    ...
    <>
      <Card className="p-6">
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          {items.length === 0 && (
            <div className="p-8 col-span-full text-center text-muted-foreground">
        ...
        {totalCount > pageSize && (
          <div className="flex items-center justify-between mt-6 pt-6 border-t">
            <p className="text-sm text-muted-foreground">
              Mostrando {((currentPage - 1) * pageSize) + 1} - {Math.min(currentPage * pageSize, totalCount)} de {totalCount} items
            </p>
            <div className="flex gap-2">
              <Button
                variant="outline"
