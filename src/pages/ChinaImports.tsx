        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center">
            ...
            <p className="text-slate-400 mb-6">
              Transformación Digital Integral para LATAM
            </p>
            <div className="flex justify-center space-x-4 mb-8">
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-slate-800 hover:bg-cyan-500 flex items-center justify-center transition-all">
                <span className="text-sm">in</span>
              </a>
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-slate-800 hover:bg-cyan-500 flex items-center justify-center transition-all">
