  ...
  return (
    <div className="dark min-h-screen bg-background text-foreground">
      ...
      <main className="container mx-auto px-4 sm:px-6 max-w-3xl pt-28 pb-20">
        <h1 className="text-4xl font-black mb-8">Politica de Privacidad</h1>
        <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground">
          <p><strong>Ultima actualizacion:</strong> 11 de abril de 2026</p>

          <h2 className="text-xl font-bold text-foreground">1. Informacion que recopilamos</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-foreground">2. Como usamos tu informacion</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-foreground">3. Almacenamiento</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-foreground">4. Tus derechos</h2>
          <p>
