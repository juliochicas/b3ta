export default function CorreoEmpresarialBaratoContent() {
  return (
    <>
      ...
      <p>Antes: juanperez2003@gmail.com &rarr; {'"'}Sera empresa o persona?{'"'}</p>
      <p>Despues: hola@tuempresa.com &rarr; {'"'}Se ve serio, le escribo{'"'}</p>
