        ...
        <section className="pt-32 pb-16 bg-gradient-to-b from-slate-50 to-white">
          <div className="container mx-auto px-4 sm:px-6 max-w-4xl">
            <nav className="text-sm text-slate-400 mb-8">
              <Link href="/" className="hover:text-teal-700">Inicio</Link> / <Link href="/#servicios" className="hover:text-teal-700">Servicios</Link> / <span className="text-slate-600">{props.h1}</span>
            </nav>
          ...
          <div className="container mx-auto px-4 sm:px-6 max-w-4xl">
            ...
            <div className="flex flex-wrap gap-2">
              {props.relatedServices.map((r, i) => (
                <Link key={i} href={r.href} className="text-sm text-teal-700 bg-teal-50 hover:bg-teal-100 px-4 py-2 rounded-full transition-colors">{r.label}</Link>
              ))}
            </div>
          </div>
        </section>
